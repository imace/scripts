...
for file in `find ~/.dotfiles -maxdepth 1 -type f -exec basename {} \;`; do
...
for dir in `find ~/.dotfiles -maxdepth 1 -type d -not -name .hg \
...
find ~/.scripts -maxdepth 1 -type f -exec chmod -v 755 {} \;
